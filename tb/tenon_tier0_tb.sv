...
module tenon_tier0_tb;
    ...
    tenon_tier0_case #(.GPIO_COUNT(16), .PADS_PER_RAIL(2)) qfn32 (.done(done32));
    tenon_tier0_case #(.GPIO_COUNT(40), .PADS_PER_RAIL(4)) qfn64 (.done(done64));
    tenon_tier0_case #(.GPIO_COUNT(56), .PADS_PER_RAIL(6)) qfn88 (.done(done88));
    tenon_tier0_case #(.GPIO_COUNT(88), .PADS_PER_RAIL(8)) qfn128 (.done(done128));
