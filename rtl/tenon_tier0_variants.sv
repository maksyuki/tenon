...
module tenon_tier0_qfn32 (
    ...
    tenon_tier0_reference #(.GPIO_COUNT(16), .PADS_PER_RAIL(2)) u_reference (.*);
endmodule
...
module tenon_tier0_qfn64 (
    ...
    tenon_tier0_reference #(.GPIO_COUNT(40), .PADS_PER_RAIL(4)) u_reference (.*);
endmodule
...
module tenon_tier0_qfn88 (
    ...
    tenon_tier0_reference #(.GPIO_COUNT(56), .PADS_PER_RAIL(6)) u_reference (.*);
endmodule
...
module tenon_tier0_qfn128 (
    ...
    tenon_tier0_reference #(.GPIO_COUNT(88), .PADS_PER_RAIL(8)) u_reference (.*);
endmodule
